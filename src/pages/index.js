...
const IndexPage = () => (
  <Layout pageInfo={{ pageName: "index" }}>
    <SEO title="Wavecode - Travel Software House" keywords={[`gestionale travel`, `soluzioni gestionale travel`, `applicazione gestionale travel`]}/>
        ...
        <Row>
          <Col xs={12} lg="3" className="mb-2 mb-lg-0">
            <div className="is-box is-white text-center">
              <Link className="goto" to="/soluzioni/#gestionali"/>
          ...
          <Col xs={12} lg="3" className="mb-2 mb-lg-0">
            <div className="is-box is-white text-center">
              <Link className="goto" to="/soluzioni/#portali"/>
          ...
          <Col xs={12} lg="3" className="mb-2 mb-lg-0">
            <div className="is-box is-white text-center">
              <Link className="goto" to="/soluzioni/#integrazioni"/>
          ...
          <Col xs={12} lg="3">
            <div className="is-box is-white text-center">
              <Link className="goto" to="/soluzioni/#xml"/>
